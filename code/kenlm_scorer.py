...
if __name__ == "__main__":
    ...
    texts = [
        "i don't think this is a significant problem in practice. significant problem in practice. significant problem in practice.",
        "scientists have the trouble explaining the evolution of competitive behavior",
        "the point site sorry is don't serve here",
        "the sorry point site blah ajbhbs",
        "there there there am am am am", "<EOS>",
        "seriously however dear dear dax i bed assembly bed dear dear assembly bed <EOS> <EOS>"]
